...
func ConfigureServer(s *http.Server, conf *Server) error {
	...
	if s.TLSConfig == nil {
		...
		// ECDHE_RSA_WITH_AES_256_GCM_SHA384 or
		// ECDHE_ECDSA_WITH_AES_128_GCM_SHA256 or
		...
		for _, cs := range s.TLSConfig.CipherSuites {
			...
			case tls.TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,
				...
				// Additional secure edition ciphers
				tls.TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384, tls.TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384:
				haveRequired = true
			}
		}
		if !haveRequired {
			return fmt.Errorf("http2: TLSConfig.CipherSuites is missing an HTTP/2-required AES_128_GCM_SHA256/AES_256_GCM_SHA384 cipher (need at least one of TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256, TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256, TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384, or TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384)")
		}
	}
